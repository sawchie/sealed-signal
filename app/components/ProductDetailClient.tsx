...
import { formatCompactDate, formatMoney as sourceMoney, formatPercent } from "@/lib/format";
  ...
  return <main className="detail-main">
    ...
    <div className="detail-grid">
      ...
      <aside className="detail-stack">
        <section id="price-data" className="detail-panel data-panel" aria-labelledby="data-title"><h2 id="data-title">Price data</h2><p>{priceFreshness(product.marketPrice?.updatedAt, now)} · {currency}{currency !== "USD" ? " display · USD source" : ""} · sealed product</p><dl>
