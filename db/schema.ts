...
export const products = sqliteTable(
  "products",
  {
    ...
    retailSourceId: text("retail_source_id"),
    retailSourceKind: text("retail_source_kind"),
    retailSourceName: text("retail_source_name"),
    retailSourceUrl: text("retail_source_url"),
