...
export type CatalogState = { query: string; category: string; setName: string; recommendation: string; sort: string; view: "grid" | "table"; savedOnly: boolean; count: number; numeric: Record<typeof NUMERIC_KEYS[number], string> };
